...
@bot.command(name='play', help='To stream song')
...
async def tell_me_about_yourself(ctx):
    text = "My name is Beatz!\n I was built by KushGrandhi. At present I have limited features(find out more by typing !help)\n :)"
    await ctx.send(text)
